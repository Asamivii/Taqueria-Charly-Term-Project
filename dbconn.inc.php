...
function dbConnect(){
	...
	$user = "axs9858_CTEC4321Term_Project"; // put your own user name here.
	$pwd = "Darksid981215"; // put your own database password here
	$database = "axs9858_CTEC4321CMS"; // put your database name here
